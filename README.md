...
1. Reads (function `loadActivityLabels()`) *getdata-projectfiles-UCI HAR Dataset/UCI HAR Dataset/activity_labels.txt* that maps activities like ŒÈŒÌWALKINGŒÈŒÌ with their codes and keeps this mapping in the `activityLabels` data.frame.
