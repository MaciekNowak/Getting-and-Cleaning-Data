...
loadActivityLabels <- function()
{
    ...
    {
        stop("The activity labels file '", labelsFile, "' does not exist", call. = FALSE)
    }
...
loadFeatures <- function()
{
    ...
    {
        stop("The feature labels file '", featureFile, "' does not exist", call. = FALSE)
    }
...
workDir <- "getdata-projectfiles-UCI HAR Dataset/UCI HAR Dataset"
pathSep = "/"
